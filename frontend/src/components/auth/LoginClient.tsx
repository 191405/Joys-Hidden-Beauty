                ...
                >
                    ...
                    <motion.div variants={itemVariants}>
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-3 bg-transparent border border-[rgba(26,26,26,0.15)] text-[var(--color-ink)] hover:border-[var(--color-ink)] transition-colors py-[14px] text-xs tracking-wider uppercase group"
                        >
