        ...
        <div className="min-h-screen relative selection:bg-[var(--color-gold)] selection:text-white">
            ...
            <div className="lg:hidden min-h-screen relative flex flex-col">
                ...
                <div className="absolute inset-0">
                    ...
                    />
                    {/* Cinematic gradient: keeps the top image visible, darkens toward the bottom for readability */}
                    ...
                    <div className="px-7 sm:px-10 pt-8 pb-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex justify-end -mt-2">
                                <button type="button" className="text-[10px] tracking-wide text-[var(--color-gold)] hover:text-[var(--color-ink)] transition-colors">
                                    Forgot password?
                                </button>
                            </div>
                        ...
                        <p className="text-center mt-6 text-[11px] text-[var(--color-slate)] tracking-wide">
                            New here?{" "}
                            <Link href="/auth/register" className="text-[var(--color-gold)] hover:text-[var(--color-ink)] transition-colors font-medium underline underline-offset-4 decoration-[var(--color-gold)]/30 hover:decoration-[var(--color-gold)]">
                                Create an account
                            </Link>
                        </p>
                    </div>
